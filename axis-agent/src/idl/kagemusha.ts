...
export type Kagemusha = {
  ...
  instructions: [
    {
      name: 'deposit';
      docs: ['Deposit tokens into a strategy vault.', "Creates or updates the user's position."];
    ...
    },
    {
      ...
      discriminator: [111, 219, 97, 115, 139, 154, 231, 202];
      accounts: [
        {
          name: 'strategy';
          writable: true;
  ...
  accounts: [
    {
      name: 'strategyVault';
      discriminator: [159, 204, 238, 219, 38, 201, 136, 177];
    },
    {
      name: 'userPosition';
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          {
            name: 'owner';
            docs: ['The owner (Shogun) who created this strategy'];
            type: 'pubkey';
          },
          {
            name: 'name';
            docs: ['Human-readable name (max 32 chars)'];
            type: {
              array: ['u8', 32];
            };
          },
          {
            name: 'strategyType';
            docs: ['Strategy type: 0 = Sniper, 1 = Fortress, 2 = Wave'];
            type: 'u8';
          },
          {
            name: 'targetWeights';
          ...
          {
            name: 'numTokens';
            docs: ['Number of active tokens in the composition'];
            type: 'u8';
          },
          {
            name: 'isActive';
            docs: ['Whether the strategy is actively rebalancing'];
            type: 'bool';
          },
          {
            name: 'tvl';
            docs: ['Total value locked in the vault (in lamports equivalent)'];
            type: 'u64';
          },
          {
            name: 'feesCollected';
            docs: ['Accumulated fees collected'];
            type: 'u64';
          },
          {
            name: 'lastRebalance';
            docs: ['Last rebalance timestamp'];
            type: 'i64';
          },
          {
            name: 'bump';
    ...
    {
      name: 'userPosition';
      docs: ['Tracks individual user deposits into a strategy vault.'];
      type: {
        kind: 'struct';
        fields: [
          {
            name: 'vault';
            docs: ['The strategy vault this position belongs to'];
            type: 'pubkey';
          },
          {
            name: 'user';
            docs: ['The user who owns this position'];
            type: 'pubkey';
          },
          {
            name: 'lpShares';
            docs: ['Amount of LP tokens representing share ownership'];
            type: 'u64';
          },
          {
            name: 'depositTime';
            docs: ['Timestamp of initial deposit'];
            type: 'i64';
          },
          {
            name: 'entryValue';
            docs: ['Entry value in USDC (for PnL calculation)'];
            type: 'u64';
          },
          {
            name: 'bump';
