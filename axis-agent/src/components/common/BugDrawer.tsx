          ...
          >
            ...
            <div className="max-w-md mx-auto relative font-serif">
              ...
              <motion.div 
                ...
                className="mb-8"
              >
                <p className="text-center text-xs text-white/30 font-sans mb-3 tracking-widest uppercase">Direct Line</p>
                  ...
                  <div className="relative p-5 flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="px-2 py-0.5 bg-orange-500/10 border border-orange-500/20 text-orange-400 text-[9px] font-bold rounded-sm tracking-widest">FOUNDER</span>
                      </div>
                      <div className="flex items-center gap-1.5 text-white/40 text-xs font-sans">
                        <Send size={12} className="text-orange-500/50" />
                        <span className="group-hover:text-white/70 transition-colors">@muse_jp</span>
                      </div>
                    </div>
              ...
              {status === 'success' ? (
                ...
                >
                  ...
                  <p className="text-sm font-sans text-white/40">We will analyze your report shortly.</p>
                </motion.div>
              ) : (
                <form onSubmit={submitReport} className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-orange-500 transition-colors font-mono">@</span>
                      <input 
                        name="user_tg"
                        type="text" 
                        value={tgId}
