...
export const TutorialOverlay = ({ onComplete, onConnectWallet }: TutorialOverlayProps) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[1000000] bg-[#0C0A09] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] rounded-full blur-[120px] opacity-10 bg-orange-700" />
        <div className="absolute top-0 right-0 w-[200px] h-[200px] rounded-full blur-[120px] opacity-10 bg-amber-600" />
      </div>
        ...
        >
          <div className="flex flex-col items-center text-center max-w-sm">
            ...
            <div className="relative mb-10">
              ...
              <div className="glass w-28 h-28 rounded-full flex items-center justify-center border border-white/10">
                <Icon
                  className="w-12 h-12"
