      ...
      >
        ...
        <div className="p-6 pb-2 relative z-10">
          <div className="flex justify-between items-start mb-3">
            <div>
              <div
                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase border mb-2 ${typeColors[strategy.type] || typeColors.BALANCED}`}
              >
                {strategy.type}
              </div>
        ...
        <div className="px-6 py-2 grid grid-cols-2 gap-3 relative z-10">
          ...
          <div className="col-span-1 rounded-2xl border border-white/10 bg-[#0a0a0a] shadow-inner flex flex-col items-center justify-center h-[100px] relative overflow-hidden group">
            ...
            <FormatChange
              value={strategy.roi}
              className="text-3xl drop-shadow-sm z-10"
              iconSize="w-6 h-6"
            />
          </div>
          ...
          <div className="col-span-1 rounded-2xl border border-white/10 bg-[#0a0a0a] shadow-inner flex flex-col justify-center px-4 h-[100px] relative overflow-hidden">
            ...
            <span className="text-[10px] text-white/40 uppercase font-bold tracking-widest mb-1 z-10">
              TVL (USDC)
            </span>
        ...
        <div className="flex-1 px-6 py-2 overflow-hidden flex flex-col relative z-10">
          ...
          <div className="flex-1 overflow-y-auto space-y-2 pr-1 custom-scrollbar mask-image-b">
            {strategy.tokens.map((token, i) => (
              <div
                key={i}
                className="flex items-center justify-between p-2.5 rounded-xl hover:bg-white/5 transition-colors group border border-transparent hover:border-white/10 bg-black/30"
              >
                {/* Left */}
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-sm text-white tracking-wide group-hover:text-white transition-colors">
                      {token.symbol}
                    </div>
                ...
                <div className="text-right min-w-[70px]">
                  ...
                  {token.change24h !== undefined ? (
                    ...
                    <div className="w-full h-1 bg-white/10 rounded-full mt-2 overflow-hidden">
                      <div
                        className="h-full bg-white/80 rounded-full shadow-[0_0_8px_rgba(255,255,255,0.5)]"
