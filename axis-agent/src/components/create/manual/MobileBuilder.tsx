              ...
              >
                {!searchQuery && preferences.favorites.size > 0 && activeTab !== 'prediction' && (
                  <div className="px-4 py-3 border-b border-white/5">
                    <span className="text-[10px] text-white/30 uppercase tracking-wider font-bold mb-2 block">
                      Starred
                    </span>
                  ...
                  <div className="px-3 pt-4 pb-10">
                    {groupedPredictions.map((group) => (
                      <PredictionEventCard
                        ...
                        isYesSelected={
                          group.yesToken ? selectedIds.has(group.yesToken.address) : false
                        }
                        isNoSelected={
                          group.noToken ? selectedIds.has(group.noToken.address) : false
                        }
        ...
        {flyingToken && (
          ...
          >
            <TokenImage
              ...
              className="w-12 h-12 rounded-full shadow-xl shadow-[#B8863F]/50 ring-2 ring-[#B8863F]"
            />
          </motion.div>
        )}
      </AnimatePresence>
