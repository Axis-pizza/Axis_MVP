...
export const StrategyPreview = ({ strategy, selected, onSelect, expanded = false }: StrategyPreviewProps) => {
  const Icon = typeIcons[strategy.type];
  const colors = typeColors[strategy.type];
  ...
  return (
    <motion.div
      ...
      className={`
        ...
        ${selected 
          ? `bg-gradient-to-br ${colors.bg} border-2 ${colors.border} shadow-xl` 
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-start gap-3 mb-4">
          <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${colors.bg} flex items-center justify-center ${colors.border} border`}>
        ...
        <div className="grid grid-cols-4 gap-2 p-3 bg-black/30 rounded-xl mb-4">
          <div className="text-center">
            ...
            <p className={`text-sm font-bold ${colors.text}`}>+{strategy.metrics.expectedApy}%</p>
          </div>
          <div className="text-center">
