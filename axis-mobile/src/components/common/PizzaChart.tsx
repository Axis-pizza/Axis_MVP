...
export const PizzaChart = ({ slices, size = 200, showLabels = true, animated = true }: PizzaChartProps) => {
  ...
  if (!slices.length) {
    return (
      ...
      >
        <Text className="text-[#D97706]/50 text-sm font-serif italic">Select Assets</Text>
      </View>
    );
  }

  return (
    <View className="relative flex items-center justify-center" style={{ width: size + 80, height: size + 80 }}>
      <svg
        width={size + 80}
        height={size + 80}
