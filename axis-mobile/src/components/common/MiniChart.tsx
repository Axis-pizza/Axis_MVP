...
export const MiniChart = ({ isPositive, intensity }: { isPositive: boolean, intensity: number }) => {
  ...
  return (
    <View className="relative w-full h-24 mt-2 mb-4">
      <svg viewBox="0 0 200 60" className="w-full h-full overflow-visible">
        ...
        />
        {/* 背景のグラデーション */}
        <Textath d="M0,45 Q20,35 40,50 T80,25 T120,45 T160,15 T200,30 V60 H0 Z" fill={`url(#grad-${isPositive ? 'up' : 'down'})`} opacity="0.1" />
