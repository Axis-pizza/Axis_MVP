...
const THEME = {
  ...
  fonts: {
    // iOSには最初からTimes New Romanが入っているのでそれを指定
    // Androidは入っていないので、標準の明朝体('serif')を指定
    regular: Platform.OS === 'ios' ? 'Times New Roman' : 'serif',
    bold: Platform.OS === 'ios' ? 'Times New Roman' : 'serif', 
  }
};
